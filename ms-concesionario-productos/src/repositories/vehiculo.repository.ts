...
import {Vehiculo, VehiculoRelations, Marca, Categoria, CatgoriaVehiculo, Foto, Proveedor} from '../models';
import {MarcaRepository} from './marca.repository';
import {CatgoriaVehiculoRepository} from './catgoria-vehiculo.repository';
...
> {
  ...
  constructor(
    ...
    this.categorias = this.createHasManyThroughRepositoryFactoryFor('categorias', categoriaRepositoryGetter, catgoriaVehiculoRepositoryGetter,);
